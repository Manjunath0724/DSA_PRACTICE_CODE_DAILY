...
public class lt_3606 {
    ...
    public static void main(String[] args) {
        lt_3606 lt = new lt_3606();
        String[] code = { "abc123", "def456", "ghi789", "jkl012" };
        String[] businessLine = { "electronics", "grocery", "pharmacy", "restaurant" };
        boolean[] isActive = { true, true, true, true };
        System.out.println(lt.validateCoupons(code, businessLine, isActive));
    }
